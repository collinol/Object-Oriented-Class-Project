...
/*
 * FACADE pattern to handle the logic flow of the user inputs
 */
		...
		while (in.hasNextLine()){
            ...
            if (lineScanner.hasNext())
            {
                ...
                if (command.contains("--help")) {
                    ...
                    System.out.println("browse <arguemnt>: browse either all items on auction <argument = ah>, or items for sale by client <argument = client's id>");
                    System.out.println("sell: sell item -- you will be given the option to select client to sell from if not specified as second argument");
                    System.out.println("bid: bid on item -- you will be given the option to select client to bid from if not specified as second argument");
                    ...
                    if (option3.equals("ah")) {
                        ...
                        ArrayList<ItemTemplate> auctionHouseItems = server.listItems();
                        for (ItemTemplate item : auctionHouseItems){
                        	System.out.println("listed ->"+item.getItemName());
